...
struct CMainSignals {
    ...
    /** Notifies listeners of an updated transaction without new data (for now: a coin.base potentially becoming visible). */
    ...
    /** Notifies listeners that a key for mining is required (coin.base) */
